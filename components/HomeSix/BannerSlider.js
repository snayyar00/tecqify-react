                ...
                >
                    <div className="seo-banner">
                                    ...
                                    <div className="row align-items-center">
                                        ...
                                        <div className="col-lg-6">
                                            <div className="seo-banner-image animate-tb">
                                                <img src={require("../../images/seo-banner/seo-banner1.png")} alt="image" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="shape-img13">
                            <img src={require("../../images/shape/shape13.png")} alt="image" />
                        </div>
                        <div className="shape-img14">
                            <img src={require("../../images/shape/shape14.png")} alt="image" />
                        </div>
                    </div>
                            ...
                            <div className="d-table-cell">
                                <div className="container mt-50">
                                    <div className="row align-items-center">
                                        ...
                                        <div className="col-lg-6">
                                            <div className="seo-banner-image animate-tb">
                                                <img src={require("../../images/seo-banner/seo-banner2.png")} alt="image" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="d-table-cell">
                                <div className="container mt-50">
                                    <div className="row align-items-center">
                                        ...
                                        <div className="col-lg-6">
                                            <div className="seo-banner-image animate-tb">
                                                <img src={require("../../images/seo-banner/seo-banner3.png")} alt="image" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
