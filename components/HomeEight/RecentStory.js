                                ...
                                <div className="single-blog-post">
                                    <div className="post-image">
                                        <Link href="/blog-details">
                                            <a>
                                                <img src={require("../../images/blog-image/blog-image10.jpg")} alt="image" />
                                            </a>
                                        </Link>
                                    </div>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-blog-post">
                                    <div className="post-image">
                                        <Link href="/blog-details">
                                            <a>
                                                <img src={require("../../images/blog-image/blog-image11.jpg")} alt="image" />
                                            </a>
                                        </Link>
                                    </div>
                                    <div className="post-content">
                            ...
                            <div className="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                                <div className="single-blog-post">
                                    <div className="post-image">
                                        <Link href="/blog-details">
                                            <a>
                                                <img src={require("../../images/blog-image/blog-image12.jpg")} alt="image" />
                                            </a>
                                        </Link>
                                    </div>
                                    <div className="post-content">
